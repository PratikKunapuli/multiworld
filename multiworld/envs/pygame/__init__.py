...
def register_soroush_u_wall_envs():
    ...
    # NEW
    register(
        id='PointmassUWallTrainEnvHard-v1',
        entry_point='multiworld.envs.pygame.point2d:Point2DWallEnv',
        tags={
            'git-commit-hash': 'e5c11ac',
            'author': 'Pratik'
    ...
    # NEW 
    register(
        id='Image48PointmassUWallTrainEnvHard-v1',
        entry_point=create_image_48_pointmass_uwall_train_env_hard_v1,
        tags={
            'git-commit-hash': 'e5c11ac',
            'author': 'Pratik'
        },
...
# NEW
def create_image_48_pointmass_uwall_train_env_hard_v1():
    from multiworld.core.image_env import ImageEnv
